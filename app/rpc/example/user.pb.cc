...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "se\022#\n\006result\030\001 \001(\0132\023.example.ResultCode\022"
  "\017\n\007success\030\002 \001(\0102H\n\016UserServiceRpc\0226\n\005Lo"
  "gin\022\025.example.LoginRequest\032\026.example.Log"
...
const ::_pbi::DescriptorTable descriptor_table_user_2eproto = {
    false, false, 263, descriptor_table_protodef_user_2eproto,
    "user.proto",
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "example.ResultCode.msg"));
        } else
          goto handle_unusual;
        continue;
      default:
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "example.LoginRequest.name"));
        } else
          goto handle_unusual;
        continue;
      // string pwd = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "example.LoginRequest.pwd"));
        } else
          goto handle_unusual;
        continue;
      default:
